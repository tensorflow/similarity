...
class SingleShotMemorySampler(Sampler):
    def __init__(self,
        ...
        The `batch_size` used during training will be equal to:
        `examples_per_batch * amplification` where amplification is
        how many augmented examples are generated by the augmenter for each
        examples_per_batch.
        ...
        Args:
            ...
            examples_per_batch: effectively the number of element to pass to the
        ...
        super().__init__(examples_per_batch,
                         examples_per_class_per_batch=num_augmentations_per_example,  # noqa
                         steps_per_epoch=steps_per_epoch,
                         augmenter=augmenter,
                         warmup=warmup)
        self.x = x

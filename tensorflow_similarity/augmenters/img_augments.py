...
def cutout_video(image: tf.Tensor, replace: int = 0) -> tf.Tensor:
    ...
    forward_pad = tf.maximum(0, image_depth - cutout_center_depth - pad_size_depth)
...
class AutoAugment(ImageAugment):
    ...
    def distort(self, image: tf.Tensor) -> tf.Tensor:
        ...
        Returns:
          ...
          based on the `policies` pass into the function.
        """
        ...
        # tf_policies are functions that take in an image and return an
        # augmented image.
        tf_policies = []

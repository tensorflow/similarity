# TFSimilarity.losses.SoftNearestNeighborLoss
...
<b>labels</b> must be  a 1-D integer <b>Tensor</b> of shape (batch_size,).
It's values represent the classes associated with the examples as
**integer  values**.

<b>embeddings</b> must be 2-D float <b>Tensor</b> of embedding vectors.
...
<tr class="alt">
<td colspan="2">
<b>distance</b>: Which distance function to use to compute
            the pairwise distances between embeddings.
            Defaults to 'sql2'.

<b>temperature</b>: Alters the value of loss function.
               Defaults to 1.

<b>name</b>: Loss name. Defaults to SoftNearestNeighborLoss.
</td>
</tr>

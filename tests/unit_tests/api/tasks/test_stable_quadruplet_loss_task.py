...
def test_quad_loss_build():
    ...
    quadloss_task = StableQuadrupletLossTask(
        x, y, tower_model(), hard_mining=False)
    quadloss_task.build()
...
def test_quad_loss_gen():
    ...
    labels = ["push", "pull", "stability", "hard_tuple",
...
def test_meta_quad_loss_fit():
    ...
    quadloss_task = MetaTask(
        ...
        StableQuadrupletLossTask(x, y, tower_model(), hard_mining=False))

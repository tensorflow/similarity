...
from tensorflow_similarity.search.linear import Linear
...
def test_batch_vs_single(tmp_path):
    ...
    # build search_index
    search_index = Linear("cosine", vect_dim)
